...
/*==================================================*/
	...
	{
		wp_register_style( 'reset', get_template_directory_uri() . '/assets/css/reset.css', '', '', 'screen' );
...
/*==================================================*/
	...
	function register_scripts() 
	{
		...
		wp_register_script( 'functions', get_template_directory_uri() . '/assets/js/functions.js', array( 'jquery' ), '', true);
	}
