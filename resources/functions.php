...
if (! class_exists('Roots\\Sage\\Container')) {
    if (! file_exists($composer = __DIR__.'/../vendor/autoload.php')) {
        $scaffolder_error(
            __('You must run <code>composer install</code> from the Scaffolder directory.', 'scaffolder'),
            __('Autoloader not found.', 'scaffolder')
        );
    }
 ...
 * 3. When we call get_template_directory() or get_template_directory_uri(), we point it back to themes/scaffolder/resources
 *
 * We do this so that the Template Hierarchy will look in themes/scaffolder/resources/views for core WordPress themes
 * But functions.php, style.css, and index.php are all still located in themes/scaffolder/resources
 *
 * This is not compatible with the WordPress Customizer theme preview prior to theme activation
 *
 * get_template_directory()   -> /srv/www/example.com/current/web/app/themes/scaffolder/resources
 * get_stylesheet_directory() -> /srv/www/example.com/current/web/app/themes/scaffolder/resources
 * locate_template()
 * ├── STYLESHEETPATH         -> /srv/www/example.com/current/web/app/themes/scaffolder/resources/views
 * └── TEMPLATEPATH           -> /srv/www/example.com/current/web/app/themes/scaffolder/resources
 */
array_map(
    'add_filter',
